...
if __name__ == "__main__":
	...
	opts["n_passes"] = 100 # Maximum number of passes to run before halting
	...
	weights = train_tron("data/labeledTrainData.tsv",opts)
	
	#testing and saving predictions into preds
	preds = test_tron("data/testData.tsv",weights,opts)

	#writing kaggle submission
	with open("popcorn2.csv","wb") as outfile:
